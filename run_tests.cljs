#!/usr/bin/env nbb
;; run_tests.cljs — m365-ingest actor の検査。
;;
...
;; 2026-07-18 の rescue commit で入った `src/m365_ingest/murakumo.cljc` は
